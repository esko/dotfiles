...

{
  ...
  optionalPackages =
    ...
    builtins.concatLists (
      map (name: lib.optional (builtins.hasAttr name pkgs) (builtins.getAttr name pkgs)) names
    );
    ...
    builtins.concatLists (
      map (
        ...
        if builtins.hasAttr name pkgs then
          let
            package = builtins.getAttr name pkgs;
          in
          lib.optional (lib.attrByPath [ "meta" "license" "free" ] true package) package
        else
          [ ]
      ) names
    );
