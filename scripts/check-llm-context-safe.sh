...
while IFS= read -r -d '' path; do
    case "$path" in
        */auth.json|*/oauth_creds.json|*/credentials.json|*/history.jsonl|*/sessions/*|*/transcripts/*|*/file-history/*|*/shell-snapshots/*|*/state_*.sqlite|*api-key*|*apikey*)
...
token_pattern='(^|[^A-Za-z])(sk-[A-Za-z0-9]{20,}|gh[pousr]_[A-Za-z0-9]{20,}|AIza[A-Za-z0-9_-]{30,}|xox[baprs]-[A-Za-z0-9-]{20,})'
